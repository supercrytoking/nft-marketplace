...
export default function Button(props) {
    ...
    return (
        <button {...props} type={type || 'button'} className={classNames('bg-zinc-400 text-zinc-900 px-4 py-2 relative', disabled && 'opacity-50 line-through pointer-events-none', className)}>
